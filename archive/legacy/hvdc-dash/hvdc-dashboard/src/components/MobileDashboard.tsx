...
function StatCard({ icon, label, value, color }: any) {
    ...
    return (
        <div className={`bg-gradient-to-br ${colors[color] || colors.blue} text-white rounded-xl p-4 shadow-lg`}>
...
function MetricCard({ label, value, unit, color }: any) {
    ...
    return (
        <div className={`bg-white border-2 ${colors[color] || colors.blue} rounded-xl p-4 shadow-sm`}>
